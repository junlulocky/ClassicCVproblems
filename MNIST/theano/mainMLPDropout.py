...
Run with:
     ...
     ./mainMLPDropout.py dropout

for dropout, or

    ./mainMLPDropout.py backprop
...
from layers.hiddenLayer import HiddenLayer, DropoutHiddenLayer, _output_from_dropout
from layers.logisticRegLayer import LogisticRegressionLayer
from loader import load_data
from update.activationFunctions import ReLU, Sigmoid, Tanh
...
class MLP_Dropout(object):
    ...
    def __init__(self,
        ...
        #first_layer = True
        # dropout the input
        next_dropout_layer_input = _output_from_dropout(rng, input, p=dropout_rates[0])
        layer_counter = 0
